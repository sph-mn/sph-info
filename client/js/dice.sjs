(module.define "sph-info.other.dice"
  (l ()
    ...
    (input-sides.addEventListener "change" (_.debounce (l () (console.log "changed")) 500))
    ...
    (button-roll.addEventListener "click"
      (l () (set result-container.innerHTML "") (result-container.appendChild roll-text)
        (setTimeout
          (l () (set result-container.innerHTML "")
