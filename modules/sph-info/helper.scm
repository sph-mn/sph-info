...
(use-modules (sph) (sph filesystem)
  ...
  (sph web app) (sph web app http) (sph web http) (sph web shtml) (sxml simple))

(export cache-headers default-links
  path-processed process-unique-number
  program-paths-f respond-shtml
  route->body-class route-handler
  route-new route-path
  route-title shtml-layout
  shtml-text-file-form sph-info-request-bind swa-env-web-base-path top-bar-links)
