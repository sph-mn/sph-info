(define-module (sph-info time calculator))

(use-modules (sph) (sph-info helper)
  (sph alist) (sph list)
  (sph module) (sph number)
  (sph time) (sph web app) (sph web app client) (sph web app http) (sph web shtml))

(export ses-utc-leap-second-table time-calculator-routes)
