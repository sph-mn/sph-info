(library (ytilitu http other)
  ...
  (define other-ip-route
    (route-new "/other/ip" "what is my ip?"
      (l (request)
        (ytilitu-request-bind request (swa-env data route routes)
        ...
        (ytilitu-request-bind request (swa-env data route time-start routes)
          (respond-shtml
            (shtml-layout (shtml-dice route) #:body-class
              ...
              (top-bar-links routes "/other" "dice"))
        ...
        (ytilitu-request-bind request (swa-env data time-start route routes)
          (respond-shtml
            (shtml-layout (shtml-yes-or-no route) #:body-class
              ...
              (top-bar-links routes "/other" "yes-or-no"))
            (cache-headers time-start))))))
  ...
  (define other-rhymes-route
    (route-new "/other/rhymes" "rhyming words"
      (l (request)
        (ytilitu-request-bind request (swa-env data routes route time-start)
          (respond-shtml
            (shtml-layout (shtml-rhymes route) #:body-class
              ...
              (top-bar-links routes "/other" "rhymes"))
            (cache-headers time-start))))))
