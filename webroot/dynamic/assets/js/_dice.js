...
module.define("sph-info.other.dice", function() {
    function div(a, css_class) {
        return function(b) {
            b.setAttribute("class", css_class);
            b.innerHTML = a;
            return b;
        }(document.createElement("div"));
    }
    var roll_text = div("roll, roll, roll...", "roll");
    ...
    input_sides.addEventListener("change", _.debounce(function() {
    ...
    function dice_roll(sides) {
        "negative sides do not make that much sense but are supported";
        if (sides > 0) {
    ...
    return button_roll.addEventListener("click", function() {
        ...
        result_container.appendChild(roll_text);
        return setTimeout(function() {
            result_container.innerHTML = "";
            return result_container.appendChild(div(dice_roll(parseInt(input_sides.value)), "number"));
        }, 700);
    });
});
